...
const kafkaClusters: KafkaCluster[] = [
  {
    ...
    name: "Dev",
    description:
      "This cluster is for non-production workloads and used in various staging environments. Please note, you should not consume messages in this cluster from your production workloads!",
  },
  {
    id: "kc-2",
    name: "Prod",
    description:
      "This is the production cluster used for production workloads. This cluster has the highes resource allocations and is used for business critical messages.",
  },
];
...
const messageContracts: MessageContract[] = [
  {
    ...
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas feugiat tempus arcu. Sed maximus est.",
    schema:
  ...
  },
  {
    ...
    description:
      "Aenean est turpis, volutpat id leo vitae, dapibus congue nisi.",
    schema: "<schema>",
    example: "<example>",
    status: "Provisioned",
  },
...
const capabilities: Capability[] = [
  ...
  },
  {
    ...
    description:
      "Integer enim neque volutpat ac tincidunt vitae semper quis lectus nulla at volutpat diam ut",
    members: [
      {
        email: "jandr@dfds.com",
      },
  ...
  },
  {
    ...
    description:
      "Vel facilisis volutpat est velit egestas dui id ornare arcu odio ut sem nulla pharetra diam sit amet nisl suscipit adipiscing bibendum est ultricies integer quis auctor elit sed vulputate",
    members: [
      {
