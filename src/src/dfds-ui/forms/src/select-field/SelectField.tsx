...
import { InputAddon } from '@/dfds-ui/react-components/src/forms/input/InputComposition'
...
export const SelectField = React.forwardRef(SelectFieldInner) as <T>(
  props: SelectFieldProps<T> & { ref?: React.ForwardedRef<any> }
