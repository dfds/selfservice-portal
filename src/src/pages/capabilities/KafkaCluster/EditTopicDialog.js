...
import { Button, SideSheet, SideSheetContent, TextField } from '@dfds-ui/react-components';

export default function EditTopicDialog({ originalTopic, inProgress, allowedToUpdate, onUpdateClicked, onCloseClicked }) {
