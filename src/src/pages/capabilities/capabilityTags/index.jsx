    ...
    if (defaultValues) {
      ...
      if (data?.costCenterInput) {
        const selectedOption = ENUM_COSTCENTER_OPTIONS.find(
          (opt) => opt.value === data.costCenterInput,
        );
      ...
      if (data?.dataClassificationInput) {
        const selectedOption = ENUM_CLASSIFICATION_OPTIONS.find(
          (opt) => opt.value === data.dataClassificationInput,
        );
      ...
      if (data?.serviceCriticalityInput) {
        const selectedOption = ENUM_CRITICALITY_OPTIONS.find(
          (opt) => opt.value === data.serviceCriticalityInput,
        );
      ...
      if (data?.serviceAvailabilityInput) {
        const selectedOption = ENUM_AVAILABILITY_OPTIONS.find(
          (opt) => opt.value === data.serviceAvailabilityInput,
        );
    ...
    <>
      ...
      <form onSubmit={handleSubmit(submitWrapper)}>
        ...
        <div>
          ...
          />
          <div className={styles.errorContainer}>
            {errors.sunsetDateInput && (
              <span className={styles.error}>
                {errors.sunsetDateInput.message}
              </span>
            )}
          </div>
        </div>
        ...
        <div>
          ...
          />
          <div className={styles.errorContainer}>
            {errors.dataClassificationInput && (
              <span className={styles.error}>
                {errors.dataClassificationInput.message}
              </span>
            )}
          </div>
        </div>
        ...
        <div>
          ...
          />
          <div className={styles.errorContainer}>
            {errors.serviceCriticalityInput && (
              <span className={styles.error}>
                {errors.serviceCriticalityInput.message}
              </span>
            )}
          </div>
        </div>
        ...
        <div>
          ...
          />
          <div className={styles.errorContainer}>
            {errors.serviceAvailabilityInput && (
              <span className={styles.error}>
                {errors.serviceAvailabilityInput.message}
              </span>
            )}
          </div>
        </div>
