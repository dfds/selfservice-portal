...
const FERRY_BUSINESS_CAPABILITIES = [
  ...
  {
    label: "Voyage Fuel Emission Optimisation",
    value: "voyage-fuel-emission-optimisation",
  },
    ...
    return [
      {
        ...
        label: "No configured Business Capabilities -- contact your enterprise architect to get yours added",
      },
    ];
  }
...
export const ENUM_CLASSIFICATION = [
  "Private",
  "Confidential",
  "Restricted",
  "Public",
